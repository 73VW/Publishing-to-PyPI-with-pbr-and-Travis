...
- Перейдите на `Travis home page`_.
...
Документация очень хорошо написана, и я предлагаю вам сначала прочесть её, так как я не буду объяснять всё. Вы можете найти её `здесь <https://docs.travis-ci.com/user/getting-started/>`_.
